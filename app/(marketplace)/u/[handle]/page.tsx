...
function StatChip({
  ...
  return (
    <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] px-3.5 py-2.5">
      ...
      <Card className="flex flex-col gap-6 p-6 sm:p-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-4 sm:gap-5">
            <span
              className="inline-flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-white/[0.10] bg-gradient-to-br from-accent-blue/25 to-accent-teal/20 text-lg font-semibold text-ink sm:h-20 sm:w-20 sm:text-xl"
              aria-hidden
            >
            ...
            <div className="min-w-0">
              <h1 className="flex flex-wrap items-center gap-2 text-2xl font-semibold tracking-tight text-ink">
                ...
                {verified ? (
                  <span className="inline-flex items-center gap-1 rounded-full border border-accent-sky/30 bg-accent-sky/10 px-2 py-0.5 text-[12px] font-medium text-accent-sky">
